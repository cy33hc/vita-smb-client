...
namespace Lang
{
	void SetTranslation(int idx)
	{
		...
		if (lang.size() > 0)
		{
			sprintf(langFile, "ux0:app/SMBCLI001/lang/%s.ini", lang.c_str());
		}
		else
		{
			switch (idx)
			...
			case SCE_SYSTEM_PARAM_LANG_ITALIAN:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/Italiano.ini");
				break;
			case SCE_SYSTEM_PARAM_LANG_SPANISH:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/Spanish.ini");
				break;
			case SCE_SYSTEM_PARAM_LANG_GERMAN:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/German.ini");
				break;
			case SCE_SYSTEM_PARAM_LANG_PORTUGUESE_PT:
			case SCE_SYSTEM_PARAM_LANG_PORTUGUESE_BR:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/Portuguese_BR.ini");
				break;
			case SCE_SYSTEM_PARAM_LANG_RUSSIAN:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/Russian.ini");
				break;
			case SCE_SYSTEM_PARAM_LANG_DUTCH:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/Dutch.ini");
				break;
			case SCE_SYSTEM_PARAM_LANG_FRENCH:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/French.ini");
				break;
			case SCE_SYSTEM_PARAM_LANG_POLISH:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/Polish.ini");
				break;
			case SCE_SYSTEM_PARAM_LANG_JAPANESE:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/Japanese.ini");
				break;
			case SCE_SYSTEM_PARAM_LANG_KOREAN:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/Korean.ini");
				break;
			case SCE_SYSTEM_PARAM_LANG_CHINESE_S:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/Simplified Chinese.ini");
				break;
			case SCE_SYSTEM_PARAM_LANG_CHINESE_T:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/Traditional Chinese.ini");
				break;
			default:
				sprintf(langFile, "ux0:app/SMBCLI001/lang/English.ini");
				break;
			}
		}
